...
select * from account@YOONJB_LINK;

commit;

INSERT INTO ACCOUNT@YOONJB_LINK VALUES ('01077106366', '2-12232-23322', '1234', '14', SYSDATE, 1000, '식비', 'BK BANK', 100000, '김병관', 'bg0307','일반');
INSERT INTO ACCOUNT@YOONJB_LINK VALUES ('01029523679', '14-77777-77777', '1234', '14', SYSDATE, 1000, '식비', 'j investm BANK', 9000, '조재희', 'jaehee','오픈');
INSERT INTO ACCOUNT@YOONJB_LINK VALUES ('01011112222', '14-33332-33132', '1234', '14', SYSDATE, 1000, '식비', 'JH BANK', 9000, '박지훈', '오픈');
...
INSERT INTO member@YOONJB_LINK VALUES('00003','K','jaehee','1234','조재희','01029523679','jaehee@kopo',NULL,NULL,sysdate, '오픈', NULL);
INSERT INTO member@YOONJB_LINK VALUES('00004','K','park','1234','박지훈','01011112222','park@kopo',NULL,NULL,sysdate, '오픈', NULL);
commit;
