            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        ...
                        <form action="${ pageContext.request.contextPath }/join/joinProcess.do" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            <!-- Name input-->
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control"  name="phone" type="text" placeholder="Enter your name..." data-sb-validations="required" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control"  name="occupation" type="occupation" placeholder="name@example.com" data-sb-validations="required,email" />
                                <label for="occupation">Occupation</label>
                                <div class="invalid-feedback" data-sb-feedback="email:required">Occupation is required.</div>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input class="form-control"  name="joinpath" type="occupation" placeholder="name@example.com" data-sb-validations="required,email" />
                                <label for="joinpath">JoinPath</label>
                                <div class="invalid-feedback" data-sb-feedback="email:required">JoinPath is required.</div>
                            </div>
                            
                            <!-- Submit Button-->
                            <div class="d-grid">
                            <button class="btn btn-primary btn-xl " id="submitButton" type="submit" >Submit
                            </button>
                            </div>
                        </form>
                    </div>
